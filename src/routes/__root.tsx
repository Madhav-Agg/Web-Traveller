...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "An interactive museum of the web, rebuilt era by era in pure HTML and CSS.",
      },
      ...
      <AppStateProvider>
        ...
        <footer className="border-t border-border px-5 py-8 text-center">
          <p className="font-mono text-[11px] text-muted-foreground">
            Internet Time Machine — every page rebuilt by hand in HTML and CSS. No screenshots.
          </p>
        </footer>
      </AppStateProvider>
    </QueryClientProvider>
